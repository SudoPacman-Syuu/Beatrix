...
class NucleiScanner(BaseScanner):
    ...
    def __init__(self, config: Optional[Dict] = None):
        ...
        self.timeout_seconds = self.config.get("nuclei_timeout", 90)  # 90s default
    ...
    def add_urls(self, urls: List[str]):
        """Add URLs to scan (called by the engine after crawling)"""
        self._urls_to_scan.extend(urls)

    def set_technologies(self, technologies: List[str]):
    ...
    async def _run_nuclei(self, urls: List[str], tags: str = "") -> AsyncIterator[Finding]:
        ...
        try:
            cmd = [
                ...
                "-rate-limit", "100",        # Faster rate limit
